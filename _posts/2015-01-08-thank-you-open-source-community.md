...
* [iRate](https://github.com/nicklockwood/iRate) because we love hearing back from our users!
* [JTSImageViewController](https://github.com/jaredsinclair/JTSImageViewController) is what you see when you tap on a picture on a friend’s profile.
* [KGStatusBar](https://github.com/kevingibbon/KGStatusBar) We use this to represent “offline mode” for Braintree merchants to test out Venmo integration.
